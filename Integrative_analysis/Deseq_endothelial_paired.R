...
Endothelial_Post_vs_Pre$Type[Endothelial_Post_vs_Pre$padj < 0.05 & Endothelial_Post_vs_Pre$log2FoldChange < 0] <- "DOWN"
Endothelial_Post_vs_Pre$Type[Endothelial_Post_vs_Pre$padj < 0.05 & Endothelial_Post_vs_Pre$log2FoldChange > 0] <- "UP"
...
p4 <- ggplot(Endothelial_Post_vs_Pre, aes(x = log2FoldChange, y = -log10(padj), color = Type)) +
  ...
  ggtitle("E) DESeq2 Volcano Plot - Endothelial cells Pre vs Post")
