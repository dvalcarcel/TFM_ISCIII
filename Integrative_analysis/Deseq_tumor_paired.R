...
Tumor_Post_vs_Pre$Type[Tumor_Post_vs_Pre$padj < 0.05 & Tumor_Post_vs_Pre$log2FoldChange < 0] <- "DOWN"
Tumor_Post_vs_Pre$Type[Tumor_Post_vs_Pre$padj < 0.05 & Tumor_Post_vs_Pre$log2FoldChange > 0] <- "UP"
...
ggplot(Tumor_Post_vs_Pre, aes(x = log2FoldChange, y = -log10(padj), color = Type)) +
  ...
  ggtitle("A) DESeq2 Volcano Plot - Tumor cells Pre vs Post")
